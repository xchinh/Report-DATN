...
\begin{tabularx}{\textwidth}{|>{\RaggedRight\arraybackslash\ttfamily\small}p{4.6cm}|L{2.6cm}|L{2.6cm}|Y|}
\hline
\textrm{\textbf{Module / Package}} & \textbf{Số lượng Tests} & \textbf{Độ phủ (Coverage)} & \textbf{Kết quả Đánh giá} \\
\hline
packages/core/network & 18 ca kiểm thử & 84.5\% & Đạt (Pass 100\%) \\
\hline
packages/core/auth & 14 ca kiểm thử & 82.0\% & Đạt (Pass 100\%) \\
\hline
modules/hrm & 36 ca kiểm thử & 78.6\% & Đạt (Pass 100\%) \\
\hline
modules/ioffice & 28 ca kiểm thử & 76.2\% & Đạt (Pass 100\%) \\
\hline
modules/notification & 16 ca kiểm thử & 88.0\% & Đạt (Pass 100\%) \\
\hline
