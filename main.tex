...
\end{center}
\vspace{1cm}
Báo cáo Đồ án Tốt nghiệp đề tài \textbf{``Phát triển ứng dụng di động phục vụ nhân sự Trường Đại học''} trình bày quá trình nghiên cứu, thiết kế, hiện thực hóa và kiểm thử ứng dụng di động \textbf{MyHCMUT} tích hợp với hệ thống dịch vụ Backend hiện hữu của Nhà trường. Báo cáo được cấu trúc thành 8 chương chính như sau:
\begin{itemize}
    ...
    \item \textbf{CHƯƠNG IV: PHÂN TÍCH YÊU CẦU HỆ THỐNG} \\
    Xác định người dùng, ma trận phân quyền RBAC, yêu cầu chức năng chi tiết theo 5 phân hệ và các yêu cầu phi chức năng.
    \item \textbf{CHƯƠNG V: ĐẶC TẢ CHI TIẾT CÁC USE-CASE VÀ BIỂU ĐỒ HOẠT ĐỘNG} \\
    Sơ đồ Use Case tổng thể, bảng đặc tả chi tiết 5 Use Cases cốt lõi, hệ thống Biểu đồ hoạt động (Activity Diagrams) và Biểu đồ tuần tự (Sequence Diagrams).
    \item \textbf{CHƯƠNG VI: PHÂN TÍCH VÀ THIẾT KẾ HỆ THỐNG} \\
    ...
    \item \textbf{CHƯƠNG VII: KẾT QUẢ HIỆN THỰC VÀ KIỂM THỬ} \\
    ...
    \item \textbf{CHƯƠNG VIII: TỔNG KẾT VÀ HƯỚNG PHÁT TRIỂN} \\
...
%%% CHUONG 4: PHAN TICH YEU CAU HE THONG
\newpage
\input{Chapter4/index}

%%% CHUONG 5: DAC TA CHI TIET USE-CASE VA BIEU DO HOAT DONG
\newpage
\input{Chapter5/index}

%%% CHUONG 6: PHAN TICH VA THIET KE HE THONG
\newpage
\input{Chapter6/index}

%%% CHUONG 7: KET QUA HIEN THUC VA KIEM THU
\newpage
\input{Chapter7/index}

%%% CHUONG 8: TONG KET VA HUONG PHAT TRIEN
\newpage
\input{Chapter8/index}
