...
\begin{itemize}
    \item \textbf{Độc lập với Framework và UI:} Logic nghiệp vụ không bị ràng buộc vào các widget hiển thị của Flutter, cho phép dễ dàng tái cấu trúc giao diện mà không ảnh hưởng đến quy tắc xử lý dữ liệu.
...
\subsection{Quản lý Phiên (Session Management) và Cơ chế Shared Secret JWT Bridge}
